...
public class Shell {
	...
	public void init() {
		...
		commandList.add(new ShellCommand(shellWhereAmI, "whereami", "Tells the user where they are."));
		commandList.add(new ShellCommand(shellDate, "date", "Displays the current date and time."));
		commandList.add(new ShellCommand(shellName, "name", "Displays programmer's name."));
	...
	public static ShellCommandFunction shellMan = new ShellCommandFunction() {
		public Object execute(ArrayList<String> in) {
			if(in.size() > 0) {
				...
				if(topic.equals("cls")) {
					Globals.standardOut.putText("Clears your screen of all the garbage you already entered.");
				}
				else {
	...
	public static ShellCommandFunction shellWhereAmI = new ShellCommandFunction() {
		...
		public Object execute(ArrayList<String> input) {
			Globals.standardOut.putText("Albertus 401");
			return null;
		}
	};
	...
	public static ShellCommandFunction shellName = new ShellCommandFunction() {
		@Override
		public Object execute(ArrayList<String> in) {
			Globals.standardOut.putText("Trevor");
			return null;
